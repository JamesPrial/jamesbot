...
<Tip>
  For complete technical specifications and schemas, see [Plugins reference](.claude/skill/plugin/references/plugins-reference). For marketplace management, see [Plugin marketplaces](.claude/skill/plugin/references/plugin-marketplaces).
</Tip>

Plugins let you extend Claude Code with custom functionality that can be shared across projects and teams. Install plugins from [marketplaces](.claude/skill/plugin/references/plugin-marketplaces) to add pre-built commands, agents, hooks, Skills, and MCP servers, or create your own to automate your workflows.
...
<Note>
  **Next steps**: Ready to add more features? Jump to [Develop more complex plugins](#develop-more-complex-plugins) to add agents, hooks, and MCP servers. For complete technical specifications of all plugin components, see [Plugins reference](.claude/skill/plugin/references/plugins-reference).
</Note>
...
For detailed marketplace management including Git repositories, local development, and team distribution, see [Plugin marketplaces](.claude/skill/plugin/references/plugin-marketplaces).
...
For complete instructions including configuration examples, marketplace setup, and rollout best practices, see [Configure team marketplaces](.claude/skill/plugin/references/plugin-marketplaces#how-to-configure-team-marketplaces).
...
Plugins can include [Agent Skills](.claude/skill/plugin/references/skills) to extend Claude's capabilities. Skills are model-invoked—Claude autonomously uses them based on the task context.
...
For complete Skill authoring guidance, see [Agent Skills](.claude/skill/plugin/references/skills).

### Organize complex plugins

For plugins with many components, organize your directory structure by functionality. For complete directory layouts and organization patterns, see [Plugin directory structure](.claude/skill/plugin/references/plugins-reference#plugin-directory-structure).
...
<Note>
  **For multiple plugins**: Organize plugins in subdirectories like `./plugins/plugin-name` and update your marketplace.json accordingly. See [Plugin sources](.claude/skill/plugin/references/plugin-marketplaces#plugin-sources) for organization patterns.
</Note>
...
3. **Use validation and debugging tools**: See [Debugging and development tools](.claude/skill/plugin/references/plugins-reference#debugging-and-development-tools) for CLI commands and troubleshooting techniques
...
<Note>
  For complete technical specifications, debugging techniques, and distribution strategies, see [Plugins reference](.claude/skill/plugin/references/plugins-reference).
</Note>
...
* **Create your first marketplace**: [Plugin marketplaces guide](.claude/skill/plugin/references/plugin-marketplaces)
* **Advanced components**: Dive deeper into specific plugin components:
  * [Slash commands](.claude/skill/plugin/references/slash-commands) - Command development details
  * [Subagents](.claude/skill/plugin/references/sub-agents) - Agent configuration and capabilities
  * [Agent Skills](.claude/skill/plugin/references/skills) - Extend Claude's capabilities
  * [Hooks](.claude/skill/plugin/references/hooks) - Event handling and automation
  * [MCP](.claude/skill/plugin/references/mcp) - External tool integration
...
* [Plugin marketplaces](.claude/skill/plugin/references/plugin-marketplaces) - Creating and managing plugin catalogs
* [Slash commands](.claude/skill/plugin/references/slash-commands) - Understanding custom commands
* [Subagents](.claude/skill/plugin/references/sub-agents) - Creating and using specialized agents
* [Agent Skills](.claude/skill/plugin/references/skills) - Extend Claude's capabilities
* [Hooks](.claude/skill/plugin/references/hooks) - Automating workflows with event handlers
* [MCP](.claude/skill/plugin/references/mcp) - Connecting to external tools and services
* [Settings](.claude/skill/plugin/references/settings) - Configuration options for plugins
