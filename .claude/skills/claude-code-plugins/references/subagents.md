...
[Plugins](.claude/skill/plugin/references/plugins) can provide custom subagents that integrate seamlessly with Claude Code. Plugin agents work identically to user-defined agents and appear in the `/agents` interface.
...
See the [plugin components reference](.claude/skill/plugin/references/plugins-reference#agents) for details on creating plugin agents.
...
For detailed information about the JSON format and all available options, see the [CLI reference documentation](.claude/skill/plugin/references/cli-reference#agents-flag-format).
...
| `model`       | No       | Model to use for this subagent. Can be a model alias (`sonnet`, `opus`, `haiku`) or `'inherit'` to use the main conversation's model. If omitted, defaults to the [configured subagent model](.claude/skill/plugin/references/model-config) |

### Model selection

The `model` field allows you to control which [AI model](.claude/skill/plugin/references/model-config) the subagent uses:
...
Subagents can be granted access to any of Claude Code's internal tools. See the [tools documentation](.claude/skill/plugin/references/settings#tools-available-to-claude) for a complete list of available tools.
...
* [Plugins](.claude/skill/plugin/references/plugins) - Extend Claude Code with custom agents through plugins
* [Slash commands](.claude/skill/plugin/references/slash-commands) - Learn about other built-in commands
* [Settings](.claude/skill/plugin/references/settings) - Configure Claude Code behavior
* [Hooks](.claude/skill/plugin/references/hooks) - Automate workflows with event handlers
