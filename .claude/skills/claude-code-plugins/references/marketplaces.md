...
```json  theme={null}
{
  ...
  "source": {
    "source": "github",
    "repo": "company.claude/skill/plugin/referencesterprise-plugin"
  },
  ...
  "homepage": "https://docs.company.com/plugins.claude/skill/plugin/referencesterprise-tools",
  "repository": "https://github.com/company.claude/skill/plugin/referencesterprise-plugin",
  "license": "MIT",
  "keywords": ["enterprise", "workflow", "automation"],
  "category": "productivity",
  "commands": [
    "./commands/core/",
    "./commands.claude/skill/plugin/referencesterprise/",
...
For complete plugin testing workflows, see [Test your plugins locally](.claude/skill/plugin/references/plugins#test-your-plugins-locally). For technical troubleshooting, see [Plugins reference](.claude/skill/plugin/references/plugins-reference).
...
* [Plugins](.claude/skill/plugin/references/plugins) - Installing and using plugins
* [Plugins reference](.claude/skill/plugin/references/plugins-reference) - Complete technical specifications and schemas
* [Plugin development](.claude/skill/plugin/references/plugins#develop-more-complex-plugins) - Creating your own plugins
* [Settings](.claude/skill/plugin/references/settings#plugin-configuration) - Plugin configuration options